...
# 基础配置
BASE_URL = "https://www.usenix.org/conference/nsdi22/technical-sessions"
HEADERS = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
}
ROOT_DIR = "../conference_pdf/"
SAVE_DIR = "nsdi22_papers"
...
def get_pdf_links():
    ...
    for link in soup.select('a[href*="/conference/nsdi22/presentation/"]'):
        ...
        pdf_url = f"https://www.usenix.org/system/files/nsdi22-paper-{paper_id}.pdf"
        paper_links.append(pdf_url)
        paper_links_candidate.append(pdf_url_candidate)
        print("[+] find", pdf_url)
