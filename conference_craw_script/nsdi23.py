...
# 基础配置
BASE_URL = "https://www.usenix.org/conference/nsdi23/technical-sessions"
HEADERS = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
}
ROOT_DIR = "../conference_pdf/"
SAVE_DIR = "nsdi23_papers"
...
def get_pdf_links():
    ...
    for link in soup.select('a[href*="/conference/nsdi23/presentation/"]'):
        paper_url = urljoin(BASE_URL, link['href'])
        paper_id = paper_url.split('/')[-1]
        # 构造PDF下载链接（基于USENIX常规格式）
        pdf_url = f"https://www.usenix.org/system/files/nsdi23-{paper_id}.pdf"
